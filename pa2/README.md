cool.flex is done by myself, 60/63
perfect.flex is done by others, downloaded from github, it's 63/63.
I don't know why my code can't pass the test about null charcter in string. I can't do it, so i give it up.
